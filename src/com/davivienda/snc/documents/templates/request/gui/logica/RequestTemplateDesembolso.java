 ...
 * @author MAAACOST
 */
public class RequestTemplateDesembolso extends RequestTemplate {
    ...
    public List<String> readRequestGuide() throws ApplicationException {
        ...
        InputStream targetStream = getClass().getClassLoader().getResourceAsStream("resources/requestSrvScnGenerarDocumentoDesembolso.xml");
